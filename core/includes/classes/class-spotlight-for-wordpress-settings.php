 ...
 * 
 * SPOTLIGHTF->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Spotlight_For_Wordpress_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		SPOTLIGHTF
 * @subpackage	Classes/Spotlight_For_Wordpress_Settings
...
class Spotlight_For_Wordpress_Settings{
	...
	/**
	 * Our Spotlight_For_Wordpress_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = SPOTLIGHTF_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'SPOTLIGHTF/settings/get_plugin_name', $this->plugin_name );
	}
}
